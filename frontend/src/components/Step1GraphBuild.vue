...
.badge.processing { background: #FF5722; color: var(--text-main); }
.badge.accent { background: #FF5722; color: var(--text-main); }
.badge.pending { background: rgba(0, 0, 0, 0.3); color: var(--text-muted); }
