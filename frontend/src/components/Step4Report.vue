                ...
                <div v-else-if="currentSectionIndex === idx + 1" class="loading-state">
                  <div class="loading-icon">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
                      <circle cx="12" cy="12" r="10" stroke-width="4" stroke="var(--bg-panel-border)"></circle>
                      <path d="M12 2a10 10 0 0 1 10 10" stroke-width="4" stroke="var(--text-muted)" stroke-linecap="round"></path>
                    </svg>
                  </div>
...
.generated-content :deep(.md-h2) { font-size: 20px; border-bottom: 1px solid var(--bg-panel-border); padding-bottom: 8px; }
...
.right-panel {
  ...
  --wf-border: var(--bg-panel-border);
  --wf-divider: rgba(0, 0, 0, 0.4);

  --wf-active-bg: #FAFAFA;
  --wf-active-border: var(--text-main);
  --wf-active-dot: var(--text-main);
  --wf-active-text: var(--text-main);

  --wf-done-bg: rgba(0, 0, 0, 0.4);
  --wf-done-border: var(--bg-panel-border);
  --wf-done-dot: #10B981;

  --wf-muted-dot: var(--bg-panel-border);
...
.tool-badge.tool-purple {
  background: rgba(129, 90, 166, 0.1);
  border-color: #C4B5FD;
  color: #6D28D9;
}
...
:deep(.interview-display .expand-answer-btn) {
  ...
  background: transparent;
  border: none;
  border-bottom: 1px dotted var(--bg-panel-border);
  border-radius: 0;
  font-size: 11px;
  font-weight: 500;
  color: var(--text-muted);
...
.log-content::-webkit-scrollbar-thumb { background: var(--bg-panel); border-radius: 2px; }
